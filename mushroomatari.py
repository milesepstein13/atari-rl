...
def experiment():
    ...
    arg_alg.add_argument("--evaluation-frequency", type=int, default=250000, # CHANGE FOR SPEED
    ...
    arg_alg.add_argument("--train-frequency", type=int, default=4,
                         help='Number of collected samples before each fit of'
                              'the neural network.')
    arg_alg.add_argument("--max-steps", type=int, default=50000000, # CHANGE FOR SPEED
    ...
    arg_alg.add_argument("--test-samples", type=int, default=125000, #CHANGE FOR SPEED
